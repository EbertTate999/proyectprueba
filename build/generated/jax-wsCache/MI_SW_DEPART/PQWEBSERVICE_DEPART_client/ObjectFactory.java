 ...
 * generated in the PQWEBSERVICE_DEPART_client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Listar_QNAME = new QName("http://PQWEBSERVICE_DEPART/", "listar");
    private final static QName _ListarResponse_QNAME = new QName("http://PQWEBSERVICE_DEPART/", "listarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: PQWEBSERVICE_DEPART_client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://PQWEBSERVICE_DEPART/", name = "listar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://PQWEBSERVICE_DEPART/", name = "listarResponse")
